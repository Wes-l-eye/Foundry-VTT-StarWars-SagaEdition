...
SWSE.Combat.range = {
  'Heavy Weapons': {
    'point-blank': { string: '0-50 squares', low: 0, high: 50 },
    short: { string: '51-100 squares', low: 51, high: 100 },
    medium: { string: '101-250 squares', low: 101, high: 250 },
    long: { string: '251-500 squares', low: 251, high: 500 },
  },
  Pistols: {
    'point-blank': { string: '0-20 squares', low: 0, high: 20 },
    short: { string: '21-40 squares', low: 21, high: 40 },
    medium: { string: '41-60 squares', low: 41, high: 60 },
    long: { string: '61-80 squares', low: 61, high: 80 },
  },
  Rifles: {
    'point-blank': { string: '0-30 squares', low: 0, high: 30 },
    short: { string: '31-60 squares', low: 31, high: 60 },
    medium: { string: '61-150 squares', low: 61, high: 150 },
    long: { string: '151-300 squares', low: 151, high: 300 },
  },
  ...
  'Thrown Weapons': {
    'point-blank': { string: '0-6 squares', low: 0, high: 6 },
    short: { string: '7-8 squares', low: 7, high: 8 },
    medium: { string: '9-10 squares', low: 9, high: 10 },
    long: { string: '11-12 squares', low: 11, high: 12 },
  },
};
...
CONFIG.statusEffects.push(
  ...[
    ...
    },
    {
      ...
      changes: [
        { key: 'condition', value: '-10' },
        { key: 'speedMultiplier', value: '0.5' },
      ],
    },
    {
      ...
      changes: [
        { key: 'condition', value: 'OUT' },
        { key: 'dexterityMax', value: '0' },
        { key: 'dexterityMaxBonus', value: '0' },
      ],
    },
    {
      id: 'shield',
