...
export function resolveGrapple(actor) {
  return (
    actor.system.offense.bab +
    Math.max(actor.system.attributes.str.mod, actor.system.attributes.dex.mod) +
    getInheritableAttribute({ entity: actor, attributeKey: 'grappleSizeModifier', reduce: 'SUM' })
  );
}
