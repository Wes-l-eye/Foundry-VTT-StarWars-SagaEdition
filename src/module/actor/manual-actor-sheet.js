  ...
  _onShield(event) {
    ...
    switch (type) {
      ...
      case 'toggle':
        ...
        let tokens = Object.values(canvas.tokens.controlled).filter(
          (token) => token.document.actorId === this.actor.id,
        );
...
//   let options = [];
//   options.push({
//     name: 'Set Maximum Health Override',
...
//
//   options.push({
//     name: 'Remove Maximum Health Override',
